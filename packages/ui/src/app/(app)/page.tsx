...
// ---------------------------------------------------------------------------
// Micro sparkline — tiny inline bar chart
// ---------------------------------------------------------------------------
...
export default function OverviewPage() {
  ...
  // Week vs prior trend (rough: compare last 3 vs first 3 days of series)
      ...
      <div className="ov-grid" style={{ marginBottom: 20 }}>
        ...
        <div className="panel-block ov-feed-panel">
          <div className="panel-block-head">
            ...
            <Link href="/traces" className="ov-view-all">
        ...
        <div className="ov-right-col">
          ...
          <div className="panel-block ov-eval-card">
            <div className="panel-block-head" style={{ marginBottom: 12 }}>
              ...
              <Link href="/evals" className="ov-view-all">Details <IconArrowRight size={12} /></Link>
            </div>
